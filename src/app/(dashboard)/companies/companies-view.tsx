  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 bg-white p-3 rounded-xl border border-slate-200 shadow-2xs">
        ...
        <div className="flex gap-1 overflow-x-auto pb-1 sm:pb-0 touch-pan-x no-scrollbar">
                  ...
                  <TableRow key={company.id} className="hover:bg-slate-50/70">
                    <TableCell>
                      <div className="flex items-center gap-3">
                        <div className="h-9 w-9 rounded-lg bg-slate-100 text-slate-700 font-bold text-xs flex items-center justify-center border border-slate-200 shrink-0">
                        ...
                        <div>
                          ...
                          {company.domain && (
                            <div className="flex items-center gap-1 text-xs text-blue-600 mt-0.5">
                              ...
                              <span className="truncate max-w-[130px]">{company.domain}</span>
                            </div>
                          )}
                        </div>
                      </div>
      ...
      {/* Add Company Responsive Modal / Bottom Sheet */}
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/50 backdrop-blur-xs p-0 sm:p-4 animate-in fade-in">
          ...
          <div className="relative bg-white rounded-t-2xl sm:rounded-2xl border border-slate-200 shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto z-10 animate-in slide-in-from-bottom sm:zoom-in-95">
            ...
            <form onSubmit={handleCreateCompany} className="p-5 sm:p-6 space-y-4">
