        ...
        <CardContent className="p-5 space-y-4">
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/80 space-y-3">
            ...
            <ol className="text-xs text-slate-600 space-y-2 list-decimal list-inside">
              ...
              <li>
                Copy the <strong>Project URL</strong> and <strong>Project API Keys (anon public)</strong>.
              </li>
              <li>
                Open <code className="bg-white px-1.5 py-0.5 rounded border border-slate-200 text-slate-900 font-mono">.env.local</code> in your CEDO_CRM root directory and paste them.
              </li>
              <li>
                Open the Supabase <strong>SQL Editor</strong> and run the schema script located at:{" "}
                <code className="bg-white px-1.5 py-0.5 rounded border border-slate-200 text-slate-900 font-mono">supabase/schema.sql</code>.
              </li>
            </ol>
          </div>
      ...
      <Card className="shadow-2xs">
        <CardHeader className="p-5 border-b border-slate-100 flex flex-row items-center justify-between">
          <div>
            ...
            <CardDescription>Active sales seats and access permissions</CardDescription>
          </div>
